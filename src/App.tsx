...
function GlobalExperience(){return <><ErpExperienceBridge/><GlobalFormStandards/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/><OrderBookQuickAccess/><OrderCommitmentInvoiceBridge/><OrderBookInvoiceActions/><SalesOrderBookDraftBridge/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
