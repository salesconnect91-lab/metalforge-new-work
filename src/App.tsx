...
function GlobalExperience(){return <><ErpExperienceBridge/><GlobalFormStandards/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/><OrderBookQuickAccess/><SalesOrderBookDraftBridge/><UnifiedOrderBookInvoicePicker/><SalesInvoiceEmployeeSalespersonBridge/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
