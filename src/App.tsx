...
function GlobalExperience(){return <><ErpExperienceBridge/><GlobalFormStandards/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/><OrderBookQuickAccess/><SalesOrderBookDraftBridge/><UnifiedOrderBookInvoicePicker/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
