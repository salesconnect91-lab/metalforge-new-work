...
function GlobalExperience(){return <><ErpExperienceBridge/><GlobalFormStandards/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/><OrderBookQuickAccess/><SalesOrderBookDraftBridge/><UnifiedOrderBookInvoicePicker/><SalesInvoiceEmployeeSalespersonBridge/><ReliableInvoiceRowDelete/><DraftSalesOperationalBridge/><OrderBookRateRevisionBridge/><OrderBookCustomerReport/><SalesInvoicePrintStatusBridge/><OrderBookCancelControl/><OrderBookQtyAdjustControl/><OrderBookAdvancedFilters/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
