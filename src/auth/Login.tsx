...
export default function Login() {
  ...
  const changeLoginId = () => { setOtpSent(false); setOtp(""); setError(null); setMessage(null); };
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-6">
          <h2 className="text-center text-lg font-semibold text-slate-800">{otpSent ? "Verify Login OTP" : "Sign In"}</h2>
          <p className="mt-1 mb-5 text-center text-xs text-slate-500">{otpSent ? `OTP sent to ${normalizedEmail}` : "Enter your registered Login ID. We will send an OTP to your email."}</p>
