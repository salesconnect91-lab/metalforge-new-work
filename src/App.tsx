...
function GlobalExperience(){return <><ErpExperienceBridge/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
