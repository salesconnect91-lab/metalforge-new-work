...
import { BriefcaseBusiness, ChevronDown, Loader2, MapPin, LockKeyhole } from "lucide-react";
...
export default function BusinessUnitSwitcher(){
  ...
  return <div className="fixed right-[390px] top-[7px] z-40 hidden min-w-[260px] md:block" data-no-bilingual>
    <div className="relative rounded-xl border border-blue-200/90 bg-blue-50/95 px-2.5 py-1.5 shadow-sm backdrop-blur-xl">
      <div className="mb-0.5 flex items-center gap-1.5 px-1 text-[12px] font-bold uppercase tracking-[0.13em] text-blue-500"><BriefcaseBusiness size={10}/><span>{canSwitch?"Business Unit / بزنس یونٹ":"Business Workspace / بزنس"}</span></div>
