...
import OrderCommitmentInvoiceBridge from "@/components/OrderCommitmentInvoiceBridge";
import OrderBookInvoiceActions from "@/components/OrderBookInvoiceActions";
...
function GlobalExperience(){return <><ErpExperienceBridge/><GlobalFormStandards/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/><OrderBookQuickAccess/><OrderCommitmentInvoiceBridge/><OrderBookInvoiceActions/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
