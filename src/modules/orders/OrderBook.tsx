...
type Salesperson = { id: string; code: string | null; name: string };
  ...
  const load=useCallback(async()=>{
    ...
    try{
      ...
      const salespersonQ=sales
        ? supabase.from("salespersons").select("id,code,name").eq("is_active",true).order("name")
