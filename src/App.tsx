...
import GlobalSearchableSelects from "@/components/GlobalSearchableSelects";
...
import OrderBookAdvancedFilters from "@/components/OrderBookAdvancedFilters";
...
function GlobalExperience(){return <><ErpExperienceBridge/><GlobalFormStandards/><GlobalSearchableSelects/><PrintPreviewController/><InvoiceCommercialControls/><LockedPurchaseTaxInputs/><OrderBookQuickAccess/><SalesOrderBookDraftBridge/><UnifiedOrderBookInvoicePicker/><SalesInvoiceEmployeeSalespersonBridge/><ReliableInvoiceRowDelete/><DraftSalesOperationalBridge/><OrderBookRateRevisionBridge/><OrderBookCustomerReport/><SalesInvoicePrintStatusBridge/><OrderBookCancelControl/><OrderBookQtyAdjustControl/><OrderBookAdvancedFilters/><OrderBookActionHub/></>};function DashboardHome(){return <><DashboardGlobalSearch/><Dashboard/></>}
